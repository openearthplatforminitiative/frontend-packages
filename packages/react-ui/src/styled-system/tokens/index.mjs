const tokens = {
  ...
  "colors.primary.subtle": {
    ...
    "variable": "var(--colors-primary-subtle)"
  },
  ...
  "colors.primary.emphasized": {
    ...
    "variable": "var(--colors-primary-emphasized)"
  },
  "colors.primary.solid": {
    "value": "var(--colors-green-700)",
    "variable": "var(--colors-primary-solid)"
  },
  "colors.primary.focusRing": {
    "value": "var(--colors-green-600)",
    "variable": "var(--colors-primary-focus-ring)"
  },
  "colors.secondary.contrast": {
    "value": "white",
    "variable": "var(--colors-secondary-contrast)"
  },
  "colors.secondary.fg": {
    "value": "var(--colors-teal-700)",
    "variable": "var(--colors-secondary-fg)"
  },
  "colors.secondary.subtle": {
    "value": "var(--colors-teal-100)",
    "variable": "var(--colors-secondary-subtle)"
  },
  "colors.secondary.muted": {
    "value": "var(--colors-teal-200)",
    "variable": "var(--colors-secondary-muted)"
  },
  "colors.secondary.emphasized": {
    "value": "var(--colors-teal-300)",
    "variable": "var(--colors-secondary-emphasized)"
  },
  "colors.secondary.solid": {
    "value": "var(--colors-teal-700)",
    "variable": "var(--colors-secondary-solid)"
  },
  "colors.secondary.focusRing": {
    "value": "var(--colors-teal-600)",
    "variable": "var(--colors-secondary-focus-ring)"
  },
  "colors.tertiary.contrast": {
    "value": "white",
    "variable": "var(--colors-tertiary-contrast)"
  },
  "colors.tertiary.fg": {
    "value": "var(--colors-cyan-700)",
    "variable": "var(--colors-tertiary-fg)"
  },
  "colors.tertiary.subtle": {
    "value": "var(--colors-cyan-100)",
    "variable": "var(--colors-tertiary-subtle)"
  },
  "colors.tertiary.muted": {
    "value": "var(--colors-cyan-200)",
    "variable": "var(--colors-tertiary-muted)"
  },
  "colors.tertiary.emphasized": {
    "value": "var(--colors-cyan-300)",
    "variable": "var(--colors-tertiary-emphasized)"
  },
  "colors.tertiary.solid": {
    "value": "var(--colors-cyan-700)",
    "variable": "var(--colors-tertiary-solid)"
  },
